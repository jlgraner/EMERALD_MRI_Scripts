...
base_input_dir = os.path.join(this_env['EMDIR'], 'Data/MRI/User_Test_Data/DTI_UserTest_09182018_BIDS/dwiprep/sub-{sub}/ses-{ses}/')
base_output_dir = os.path.join(this_env['EMDIR'], 'Data/MRI/User_Test_Data/DTI_UserTest_09182018_BIDS/dwi_analysis/sub-{sub}/DWI/')
base_anat_dir = os.path.join(this_env['EMDIR'], 'Data/MRI/User_Test_Data/DTI_UserTest_09182018_BIDS/fmriprep/fmriprep/sub-{sub}/anat/')
...
tckgen_out_temp = 'sub-{sub}_ses-{ses}_run-{run}_{tract}_ML100.tck'
