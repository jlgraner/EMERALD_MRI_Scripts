...
base_input_dir = os.path.join(this_env['EMDIR'], 'Data/MRI/BIDS/dwiprep_UT/sub-{sub}/ses-{ses}/')

base_output_dir = os.path.join(this_env['EMDIR'], 'Analysis/MRI/sub-{sub}/DWI/')
base_anat_dir = os.path.join(this_env['EMDIR'], 'Data/MRI/BIDS/fmriprep_UT/fmriprep/fmriprep/sub-{sub}/anat/')
