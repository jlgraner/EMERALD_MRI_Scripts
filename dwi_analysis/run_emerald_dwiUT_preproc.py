...
base_input_dir = os.path.join(this_env['EMDIR'], 'Data/MRI/BIDS/EMERALD_UT/sub-{sub}/ses-{ses}/dwi')
base_output_dir = os.path.join(this_env['EMDIR'], 'Data/MRI/BIDS/dwiprep_UT/sub-{sub}/ses-{ses}')
...
#Create log file
log_dir = os.path.join(this_env['EMDIR'], 'Data/MRI/BIDS/dwiprep_UT/logs')
