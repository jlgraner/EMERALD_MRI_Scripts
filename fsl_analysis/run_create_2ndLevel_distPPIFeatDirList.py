...
def main():
    ...
    output_dir = os.path.join(this_env['EMDIR'], 'Analysis/MRI/Higher_distPPIfeat_postup_08122019')
...
def write_firstleveldirs(sub_list, run_list, output_file):
    ...
    firstlevel_dir_template = os.path.join(this_env['EMDIR'], 'Analysis/MRI/sub-{sub}/Func/First_Level_PPI_amy_dist_run{run}.feat')
    output_lines = []
