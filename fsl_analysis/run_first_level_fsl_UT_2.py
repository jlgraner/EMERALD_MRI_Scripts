...
template_directory = os.path.join(this_env['EMDIR'], 'Scripts/MRI_Analysis/fsl_templates/first_level_UT_template_files_08282019/')
template_file = 'first_level_design_template_UT.fsf'
...
for sub in subs_to_run:
    for run in runs_to_run:
        run_template_file = os.path.join(template_directory, '{}_run{}_first_level_design.fsf'.format(sub,run))
        ...
        try:
            ...
            this_feat_dir = os.path.join(this_env['EMDIR'], 'Analysis/MRI/sub-{}/Func/First_level_run{}.feat'.format(sub,run))
